...
public abstract class TickRateModifier {
    ...
    public TickRateModifier(CompoundTag tag) {
        this.type = TickRateModifierType.fromId(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(tag, "TickRateType"));
        this.maxDuration = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(tag, "MaxDuration");
        this.duration = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(tag, "Duration");
        this.tickRateMultiplier = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getFloat(tag, "SpeedMultiplier");
    }
    ...
    public static TickRateModifier fromTag(CompoundTag tag) {
        TickRateModifierType typeFromNbt = TickRateModifierType.fromId(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(tag, "TickRateType"));
        try {
