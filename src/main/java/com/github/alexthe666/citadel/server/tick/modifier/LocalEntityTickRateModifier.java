...
public class LocalEntityTickRateModifier extends LocalTickRateModifier {
    ...
    public LocalEntityTickRateModifier(CompoundTag tag) {
        super(tag);
        this.entityId = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(tag, "EntityId");
        this.expectedEntityType = BuiltInRegistries.ENTITY_TYPE.getValue(Identifier.parse(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getString(tag, "EntityType")));
    }
    ...
    public CompoundTag toTag() {
        ...
        Identifier resourcelocation = BuiltInRegistries.ENTITY_TYPE.getKey(this.expectedEntityType);
