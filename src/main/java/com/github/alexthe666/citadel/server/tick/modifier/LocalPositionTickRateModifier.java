...
public class LocalPositionTickRateModifier extends LocalTickRateModifier {
    ...
    public LocalPositionTickRateModifier(CompoundTag tag) {
        super(tag);
        this.center = new Vec3(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getDouble(tag, "CenterX"), com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getDouble(tag, "CenterY"), com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getDouble(tag, "CenterZ"));
    }
