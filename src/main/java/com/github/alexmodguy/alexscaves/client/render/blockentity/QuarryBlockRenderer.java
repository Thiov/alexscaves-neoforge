...
public class QuarryBlockRenderer<T extends QuarryBlockEntity> implements com.github.alexmodguy.alexscaves.client.render.blockentity.compat.BlockEntityRenderer121X<T> {

    private static final QuarryGrinderModel GRINDER_MODEL = new QuarryGrinderModel();
    private static final Identifier GRINDER_TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/quarry_grinder.png");
    ...
    public void render(T valve, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        GRINDER_MODEL.renderToBuffer(poseStack, bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(GRINDER_TEXTURE)), combinedLightIn, combinedOverlayIn, ColorUtil.packColor(1.0F, 1.0F, 1.0F, 1.0F));
        poseStack.popPose();
    }
}
