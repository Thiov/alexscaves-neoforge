...
public class BurrowingArrowRenderer extends EntityRenderer121X<BurrowingArrowEntity> {

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/burrowing_arrow.png");
    ...
    public void render(BurrowingArrowEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int lighting) {
        ...
        VertexConsumer vertexconsumer = bufferSource.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(this.getTextureLocation(entity)));
    ...
    public Identifier getTextureLocation(BurrowingArrowEntity entity) {
        return TEXTURE;
    }
