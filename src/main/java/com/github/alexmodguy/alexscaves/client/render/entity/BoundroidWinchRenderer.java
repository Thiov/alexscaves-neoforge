...
public class BoundroidWinchRenderer extends MobRenderer121X<BoundroidWinchEntity, BoundroidWinchModel> {
    ...
    public void render(BoundroidWinchEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource source, int packedLight) {
        ...
        VertexConsumer chainBuffer = source.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE_CHAIN));
    ...
    public Identifier getTextureLocation(BoundroidWinchEntity entity) {
        return TEXTURE;
    }
    ...
    class LayerGlow extends RenderLayer121X<BoundroidWinchEntity, BoundroidWinchModel> {
