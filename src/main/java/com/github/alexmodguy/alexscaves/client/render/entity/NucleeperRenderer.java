...
public class NucleeperRenderer extends MobRenderer121X<NucleeperEntity, NucleeperModel> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/nucleeper/nucleeper.png");
    private static final Identifier TEXTURE_GLOW = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/nucleeper/nucleeper_glow.png");
    private static final Identifier TEXTURE_GLASS = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/nucleeper/nucleeper_glass.png");
    private static final Identifier TEXTURE_BUTTONS_0 = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/nucleeper/nucleeper_buttons_0.png");
    private static final Identifier TEXTURE_BUTTONS_1 = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/nucleeper/nucleeper_buttons_1.png");
    private static final Identifier TEXTURE_BUTTONS_2 = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/nucleeper/nucleeper_buttons_2.png");
    private static final Identifier TEXTURE_EXPLODE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/nucleeper/nucleeper_explode.png");
    ...
    public Identifier getTextureLocation(NucleeperEntity entity) {
        return TEXTURE;
    }
    ...
    class LayerGlow extends RenderLayer121X<NucleeperEntity, NucleeperModel> {
        ...
        public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, NucleeperEntity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.getParentModel().renderToBuffer(poseStack, ivertexbuilder1, packedLightIn, LivingEntityRenderer121X.getOverlayCoords(entitylivingbaseIn, 0.0F), ColorUtil.packColor(1.0F, 1.0F, 1.0F, alpha));
            VertexConsumer ivertexbuilder2 = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityTranslucent(TEXTURE_GLASS));
            ...
            VertexConsumer ivertexbuilder3 = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.eyes(buttons));
            this.getParentModel().renderToBuffer(poseStack, ivertexbuilder3, packedLightIn, LivingEntityRenderer121X.getOverlayCoords(entitylivingbaseIn, 0.0F), -1);
            VertexConsumer ivertexbuilder4 = bufferIn.getBuffer(ACRenderTypes.getEyesAlphaEnabled(TEXTURE_EXPLODE));
            this.getParentModel().renderToBuffer(poseStack, ivertexbuilder4, packedLightIn, LivingEntityRenderer121X.getOverlayCoords(entitylivingbaseIn, 0.0F), ColorUtil.packColor(1.0F, 1.0F, 1.0F, explodeProgress));
