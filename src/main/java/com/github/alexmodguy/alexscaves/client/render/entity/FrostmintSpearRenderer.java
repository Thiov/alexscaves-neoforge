...
public class FrostmintSpearRenderer extends EntityRenderer121X<FrostmintSpearEntity> {

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/frostmint_spear.png");
    ...
    public Identifier getTextureLocation(FrostmintSpearEntity entity) {
        return TEXTURE;
    }
}
