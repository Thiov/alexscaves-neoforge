...
public class LicowitchModel extends AdvancedEntityModel<LicowitchEntity> implements ArmedModel {
    ...
    public void translateToHand(net.minecraft.client.renderer.entity.state.EntityRenderState renderStateCompat, HumanoidArm humanoidArm, PoseStack poseStack) {
        this.translateToHand(humanoidArm, poseStack);
    }
