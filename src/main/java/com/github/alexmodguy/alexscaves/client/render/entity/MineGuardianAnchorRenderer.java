...
public class MineGuardianAnchorRenderer extends EntityRenderer121X<MineGuardianAnchorEntity> {
    ...
    public void render(MineGuardianAnchorEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        VertexConsumer ivertexbuilder = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE));
    ...
    public Identifier getTextureLocation(MineGuardianAnchorEntity entity) {
        return TEXTURE;
    }
}
