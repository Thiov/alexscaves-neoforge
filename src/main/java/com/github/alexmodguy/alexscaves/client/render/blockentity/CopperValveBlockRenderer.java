...
public class CopperValveBlockRenderer<T extends CopperValveBlockEntity> implements com.github.alexmodguy.alexscaves.client.render.blockentity.compat.BlockEntityRenderer121X<T> {

    private static final CopperValveModel MODEL = new CopperValveModel();
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/copper_valve.png");
