...
public class MineGuardianRenderer extends MobRenderer121X<MineGuardianEntity, MineGuardianModel> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/mine_guardian.png");
    private static final Identifier TEXTURE_SLEEPING = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/mine_guardian_sleeping.png");
    private static final Identifier TEXTURE_EYE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/mine_guardian_eye.png");
    private static final Identifier TEXTURE_EXPLODE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/mine_guardian_explode.png");
    ...
    public Identifier getTextureLocation(MineGuardianEntity entity) {
    ...
    class LayerGlow extends RenderLayer121X<MineGuardianEntity, MineGuardianModel> {
        ...
        public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, MineGuardianEntity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            if (!entitylivingbaseIn.isEyeClosed()) {
                VertexConsumer ivertexbuilder1 = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.eyes(TEXTURE_EYE));
