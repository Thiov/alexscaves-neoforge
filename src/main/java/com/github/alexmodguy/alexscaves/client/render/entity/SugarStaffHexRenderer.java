...
public class SugarStaffHexRenderer extends EntityRenderer121X<SugarStaffHexEntity> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/sugar_staff_hex.png");
    ...
    public Identifier getTextureLocation(SugarStaffHexEntity gumballEntity) {
        return TEXTURE;
    }
}
