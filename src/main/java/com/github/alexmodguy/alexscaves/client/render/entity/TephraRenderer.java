...
public class TephraRenderer extends EntityRenderer121X<TephraEntity> {

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/tephra.png");
    ...
    public void render(TephraEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        VertexConsumer ivertexbuilder1 = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE));
    ...
    public Identifier getTextureLocation(TephraEntity entity) {
        return TEXTURE;
    }
}
