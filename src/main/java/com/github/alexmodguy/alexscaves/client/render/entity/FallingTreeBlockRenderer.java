...
public class FallingTreeBlockRenderer extends EntityRenderer121X<FallingTreeBlockEntity> {
    ...
    public Identifier getTextureLocation(FallingTreeBlockEntity entity) {
