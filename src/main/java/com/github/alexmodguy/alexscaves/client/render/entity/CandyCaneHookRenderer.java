...
public class CandyCaneHookRenderer extends EntityRenderer121X<CandyCaneHookEntity> {

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/candy_cane_hook.png");
    ...
    public void render(CandyCaneHookEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int lighting) {
        ...
        RenderType renderType = net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(this.getTextureLocation(entity));
    ...
    public void renderLicoriceString(CandyCaneHookEntity from, Vec3 fromVec, PoseStack poseStack, MultiBufferSource bufferSource, Vec3 to) {
        ...
        VertexConsumer vertexconsumer = bufferSource.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.leash());
    ...
    private static void addLicoriceStringVertexPair(VertexConsumer vertexConsumer, Matrix4f matrix4f, float x, float y, float z, int blockLightFrom, int blockLightTo, int skyLightFrom, int skyLightTo, float height, float yWidth, float xWidth, float zWidth, int vertIndex) {
        ...
        int k = net.minecraft.util.LightCoordsUtil.pack(i, j);
    ...
    public Identifier getTextureLocation(CandyCaneHookEntity entity) {
        return TEXTURE;
    }
