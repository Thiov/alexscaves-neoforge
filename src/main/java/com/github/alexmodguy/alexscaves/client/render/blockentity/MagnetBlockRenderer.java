...
public class MagnetBlockRenderer<T extends MagnetBlockEntity> implements com.github.alexmodguy.alexscaves.client.render.blockentity.compat.BlockEntityRenderer121X<T> {
        ...
        if (magnet.getRangeVisuality(partialTicks) > 0.0F) {
            ...
            if (player != null) {
                ...
                if (aabb2 != null && (magnet.canAddRange() || magnet.canRemoveRange())) {
                    com.github.alexmodguy.alexscaves.client.render.compat.ShapeRenderCompat.renderLineBox(stack, bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.lines()), aabb2, r, g, b, 0.3F * magnet.getRangeVisuality(partialTicks));

                }
            }
            com.github.alexmodguy.alexscaves.client.render.compat.ShapeRenderCompat.renderLineBox(stack, bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.lines()), aabb, r, g, b, 0.6F * magnet.getRangeVisuality(partialTicks));
            stack.popPose();
        }
    }
