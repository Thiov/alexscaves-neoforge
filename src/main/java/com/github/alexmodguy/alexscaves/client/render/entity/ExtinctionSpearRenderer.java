...
public class ExtinctionSpearRenderer extends EntityRenderer121X<ExtinctionSpearEntity> {

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/extinction_spear.png");
    ...
    public void render(ExtinctionSpearEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        VertexConsumer ivertexbuilder = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityTranslucent(getTextureLocation(entityIn)));
        MODEL.renderToBuffer(poseStack, ivertexbuilder, 240, OverlayTexture.NO_OVERLAY, -1);
        poseStack.popPose();
        super.render(entityIn, entityYaw, partialTicks, poseStack, bufferIn, packedLightIn);
    }

    public Identifier getTextureLocation(ExtinctionSpearEntity entity) {
        return TEXTURE;
    }
}
