...
public class QuarrySmasherRenderer extends EntityRenderer121X<QuarrySmasherEntity> {
    ...
    public void render(QuarrySmasherEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        VertexConsumer textureVertexConsumer = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE));
        ...
        if (entity.headPart != null && entity.tickCount > 0) {
            ...
            VertexConsumer boundroidVertexConsumer = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE_BOUNDROID));
            ...
            VertexConsumer chainBuffer = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE_CHAIN));
            poseStack.pushPose();
    ...
    public Identifier getTextureLocation(QuarrySmasherEntity entity) {
        return TEXTURE;
    }
}
