...
public class TelsaBulbBlockRenderer<T extends TeslaBulbBlockEntity> implements com.github.alexmodguy.alexscaves.client.render.blockentity.compat.BlockEntityRenderer121X<T> {

    private static final TeslaBulbModel MODEL = new TeslaBulbModel();
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/tesla_bulb.png");
