...
public class GummyBearModel extends ACAdvancedEntityModel<GummyBearEntity> implements ArmedModel {
    ...
    public void translateToHand(net.minecraft.client.renderer.entity.state.EntityRenderState renderStateCompat, HumanoidArm humanoidArm, PoseStack matrixStackIn) {
        this.translateToHand(humanoidArm, matrixStackIn);
    }
