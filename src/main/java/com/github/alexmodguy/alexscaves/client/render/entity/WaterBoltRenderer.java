...
public class WaterBoltRenderer extends EntityRenderer121X<WaterBoltEntity> {

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/deep_one/water_bolt.png");
    private static final Identifier OVERLAY_TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/deep_one/water_bolt_overlay.png");
    ...
    public Identifier getTextureLocation(WaterBoltEntity entity) {
        return TEXTURE;
    }
}
