...
public class GumWormSegmentRenderer extends EntityRenderer121X<GumWormSegmentEntity> {

    private static final Identifier TEXTURE_0 = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gum_worm_segment_0.png");
    private static final Identifier TEXTURE_1 = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gum_worm_segment_1.png");
    private static final Identifier TEXTURE_2 = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gum_worm_segment_2.png");
    private static final Identifier TEXTURE_CONNECTOR = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gum_worm_connection.png");
    ...
    public void render(GumWormSegmentEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        VertexConsumer ivertexbuilder = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(getTextureLocation(entity)));
        ...
        if(frontAttachedEntity != null){
            ...
            VertexConsumer gumConsumer = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE_CONNECTOR));
            poseStack.pushPose();
    ...
    public Identifier getTextureLocation(GumWormSegmentEntity entity) {
