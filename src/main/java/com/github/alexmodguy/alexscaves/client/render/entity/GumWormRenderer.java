...
public class GumWormRenderer extends MobRenderer121X<GumWormEntity, GumWormModel> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gum_worm.png");
    ...
    public Identifier getTextureLocation(GumWormEntity entity) {
        return TEXTURE;
    }
}
