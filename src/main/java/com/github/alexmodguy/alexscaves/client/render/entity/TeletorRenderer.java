...
public class TeletorRenderer extends MobRenderer121X<TeletorEntity, TeletorModel> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/teletor.png");
    private static final Identifier TEXTURE_GLOW = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/teletor_glow.png");
    private static final Identifier TRAIL_TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/particle/teletor_trail.png");
    ...
    public Identifier getTextureLocation(TeletorEntity entity) {
        return TEXTURE;
    }
    ...
    private void renderTrail(TeletorEntity entityIn, int side, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, float trailR, float trailG, float trailB, float trailA, int packedLightIn) {
        ...
        VertexConsumer vertexconsumer = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityTranslucent(TRAIL_TEXTURE));
    ...
    class LayerGlow extends RenderLayer121X<TeletorEntity, TeletorModel> {
