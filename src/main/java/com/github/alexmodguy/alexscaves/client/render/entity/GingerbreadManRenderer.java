...
public class GingerbreadManRenderer extends MobRenderer121X<GingerbreadManEntity, GingerbreadManModel> {
    private static final Identifier[] TEXTURES_FOR_VARIANT = new Identifier[GingerbreadManEntity.MAX_VARIANTS + 1];
    private static final Identifier TEXTURE_ALEX = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_alex.png");
    private static final Identifier TEXTURE_CARRO = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_carro.png");
    private static final Identifier TEXTURE_DENO = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_deno.png");
    private static final Identifier TEXTURE_GATETOH = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_gatetoh.png");
    private static final Identifier TEXTURE_HOLIDAY = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_holiday.png");
    private static final Identifier TEXTURE_PINKY = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_pinky.png");
    private static final Identifier TEXTURE_PLUMMET = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_plummet.png");
    private static final Identifier TEXTURE_VAKY = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_vaky.png");
    private static final Identifier TEXTURE_BLANK = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_blank.png");
    private static final Identifier TEXTURE_TEAM_OVERLAY = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_team_overlay.png");

    static {
        for (int i = 0; i <= GingerbreadManEntity.MAX_VARIANTS; i++) {
            TEXTURES_FOR_VARIANT[i] = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/gingerbread_man/gingerbread_man_" + i + ".png");
        }
    }
    ...
    public Identifier getTextureLocation(GingerbreadManEntity entity) {
    ...
    class TeamOverlayLayer extends RenderLayer121X<GingerbreadManEntity, GingerbreadManModel> {
        ...
        public void render(PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn, GingerbreadManEntity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
            if(entitylivingbaseIn.isOvenSpawned()){
                VertexConsumer ivertexbuilder2 = bufferIn.getBuffer(net.minecraft.client.renderer.rendertype.RenderTypes.entityCutout(TEXTURE_TEAM_OVERLAY));
                ...
                this.getParentModel().renderToBuffer(poseStack, ivertexbuilder2, packedLightIn, LivingEntityRenderer121X.getOverlayCoords(entitylivingbaseIn, 0.0F), ColorUtil.packColor(r, g, b, 1.0F));
            }

        }
    }

    private class ItemLayer extends ItemInHandLayer121X<GingerbreadManEntity, GingerbreadManModel> {
