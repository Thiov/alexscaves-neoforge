...
public class DarkArrowRenderer extends EntityRenderer121X<DarkArrowEntity> {

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/dark_arrow.png");
    ...
    public void render(DarkArrowEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int lighting) {
        ...
        RenderType renderType = net.minecraft.client.renderer.rendertype.RenderTypes.entityTranslucent(this.getTextureLocation(entity));
    ...
    public Identifier getTextureLocation(DarkArrowEntity entity) {
        return TEXTURE;
    }
