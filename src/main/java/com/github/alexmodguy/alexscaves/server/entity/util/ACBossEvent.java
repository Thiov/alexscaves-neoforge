...
public class ACBossEvent extends ServerBossEvent {
    ...
    public ACBossEvent(Component component, int renderType) {
        // 26.1: ServerBossEvent's constructor gained a leading UUID parameter.
        super(UUID.randomUUID(), component, BossEvent.BossBarColor.RED, BossEvent.BossBarOverlay.PROGRESS);
