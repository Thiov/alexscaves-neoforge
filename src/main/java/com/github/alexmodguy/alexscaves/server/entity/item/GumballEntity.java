...
public class GumballEntity extends ThrowableProjectile {
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        if(splitsOnHit()){
            for(int i = 0; i < 3; i++){
                GumballEntity gumballEntity = ACEntityRegistry.GUMBALL.get().create(level(), net.minecraft.world.entity.EntitySpawnReason.EVENT);
    ...
    protected void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compoundTag) {
        ...
        this.setColor(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compoundTag, "Color"));
    }
