...
public class CinderBrickEntity extends ThrowableItemProjectile {
    ...
    public CinderBrickEntity(Level level, LivingEntity thrower) {
        super(ACEntityRegistry.CINDER_BRICK.get(), thrower, level, net.minecraft.world.item.ItemStack.EMPTY);
    }

    public CinderBrickEntity(Level level, double x, double y, double z) {
        super(ACEntityRegistry.CINDER_BRICK.get(), x, y, z, level, net.minecraft.world.item.ItemStack.EMPTY);
    }
