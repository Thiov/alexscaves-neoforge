...
public class GumWormSegmentEntity extends Entity implements ICustomCollisions, KeybindUsingMount, PlayerRideableJumping, FlyingMount {
    ...
    private static final EntityDataAccessor<Optional<UUID>> FRONT_ENTITY_UUID = SynchedEntityData.defineId(GumWormSegmentEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    private static final EntityDataAccessor<Optional<UUID>> BACK_ENTITY_UUID = SynchedEntityData.defineId(GumWormSegmentEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.hasUUID(compound, "HeadUUID")) {
            this.setHeadUUID(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(compound, "HeadUUID"));
        }
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.hasUUID(compound, "FrontUUID")) {
            this.setFrontEntityUUID(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(compound, "FrontUUID"));
        }
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.hasUUID(compound, "BackUUID")) {
            this.setBackEntityUUID(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(compound, "BackUUID"));
        }
        this.setIndex(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "Index"));
    }

    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput compound) {
        if (this.getHeadUUID() != null) {
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(compound, "HeadUUID", this.getHeadUUID());
        }
        if (this.getFrontEntityUUID() != null) {
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(compound, "FrontUUID", this.getFrontEntityUUID());
        }
        if (this.getBackEntityUUID() != null) {
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(compound, "BackUUID", this.getBackEntityUUID());
        }
    ...
    public boolean hurtServer(net.minecraft.server.level.ServerLevel serverLevel, DamageSource source, float amount) {
        Entity head = this.getHeadEntity();
        if (!com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.isInvulnerableTo(this, source) && head != null) {
            head.hurtOrSimulate(source, amount);
        }
        return false;
    }
    ...
    public boolean isInvulnerableTo(DamageSource damageSource) {
        ...
        return super.isInvulnerableToBase(damageSource) || damageSource.is(DamageTypes.IN_WALL) || damageSource.is(DamageTypes.FALL);
    }
    ...
    private void pushEntities() {
        if (this.level().isClientSide()) {
            ...
            if (!list.isEmpty()) {
                int i = com.github.alexmodguy.alexscaves.server.entity.util.LevelCompat.getGameRules(this.level()).get(net.minecraft.world.level.gamerules.GameRules.MAX_ENTITY_CRAMMING);
                if (i > 0 && list.size() > i - 1 && this.random.nextInt(4) == 0) {
                    ...
                    if (j > i - 1) {
                        this.hurtOrSimulate(this.damageSources().cramming(), 6.0F);
                    }
                }
