...
public class HullbreakerEntity extends WaterAnimal implements IAnimatedEntity, KaijuMob {
    ...
    public void breakBlock() {
        ...
        if (level() instanceof net.minecraft.server.level.ServerLevel acServerLevel && net.neoforged.neoforge.event.EventHooks.canEntityGrief(acServerLevel, this) && this.getTarget() instanceof Player) {
