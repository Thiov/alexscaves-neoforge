...
public class VallumraptorEntity extends DinosaurEntity implements IAnimatedEntity, ICustomCollisions, PackAnimal, ChestThief, TargetsDroppedItems {
    ...
    protected PathNavigation createNavigation(Level level) {
        ...
        com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.setCanPassDoors(navigation, true);
        return navigation;
    }
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        this.setElder(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "Elder"));
        this.setRelaxedForTime(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "RelaxedTime"));
        this.justLootedChest = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "JustLootedChest");
    }
    ...
    public void onGetItem(ItemEntity e) {
        ...
        if (this.getAnimation() == ANIMATION_GRAB && this.getAnimationTick() > 15) {
            if (!this.getItemInHand(InteractionHand.MAIN_HAND).isEmpty() && !this.level().isClientSide()) {
                com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, this.getItemInHand(InteractionHand.MAIN_HAND), 0.0F);
            }
            this.take(e, 1);
