...
public class ThrownIceCreamScoopEntity extends ThrowableItemProjectile {
    ...
    public ThrownIceCreamScoopEntity(Level level, LivingEntity thrower) {
        super(ACEntityRegistry.THROWN_ICE_CREAM_SCOOP.get(), thrower, level, net.minecraft.world.item.ItemStack.EMPTY);
    }

    public ThrownIceCreamScoopEntity(Level level, double x, double y, double z) {
        super(ACEntityRegistry.THROWN_ICE_CREAM_SCOOP.get(), x, y, z, level, net.minecraft.world.item.ItemStack.EMPTY);
    }
    ...
    protected void onHitEntity(EntityHitResult hitResult) {
        ...
        hitResult.getEntity().hurtOrSimulate(damageSources().thrown(this, this.getOwner()), 0.0F);
