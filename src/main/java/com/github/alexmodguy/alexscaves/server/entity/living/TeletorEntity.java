...
public class TeletorEntity extends Monster {
    ...
    private static final EntityDataAccessor<Optional<UUID>> WEAPON_UUID = SynchedEntityData.defineId(TeletorEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    protected PathNavigation createNavigation(Level p_27815_) {
        ...
        com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.setCanPassDoors(flyingpathnavigation, true);
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.hasUUID(compound, "WeaponUUID")) {
            this.setWeaponUUID(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(compound, "WeaponUUID"));
        }
    }
    ...
    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput compound) {
        ...
        if (this.getWeaponUUID() != null) {
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(compound, "WeaponUUID", this.getWeaponUUID());
        }
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficultyIn, EntitySpawnReason reason, @javax.annotation.Nullable SpawnGroupData spawnDataIn) {
        MagneticWeaponEntity magneticWeapon = ACEntityRegistry.MAGNETIC_WEAPON.get().create(this.level(), net.minecraft.world.entity.EntitySpawnReason.EVENT);
    ...
    protected void dropEquipment() {
        ...
        if (weapon instanceof MagneticWeaponEntity magneticWeapon) {
            ...
            float f = this.getDropChances().byEquipment(EquipmentSlot.MAINHAND);
            if (!itemstack.isEmpty() && !EnchantmentHelper.has(itemstack, EnchantmentEffectComponents.PREVENT_EQUIPMENT_DROP) && this.random.nextFloat() < f) {
                ...
                com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, itemstack);
            }
