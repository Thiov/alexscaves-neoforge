...
public class VesperFlyAndHangGoal extends Goal {
    ...
    private boolean isOverWaterOrVoid() {
        ...
        while (position.getY() > entity.level().getMinY() && entity.level().isEmptyBlock(position)) {
    ...
    public Vec3 findHangFromPos() {
        ...
        for (int i = 0; i < 15; i++) {
            ...
            while (this.entity.level().isEmptyBlock(blockpos1) && blockpos1.getY() < this.entity.level().getMaxY()) {
