...
public class ExtinctionSpearEntity extends AbstractArrow {
    ...
    public void tick(){
        ...
        if ((this.isInGround() || this.isNoPhysics()) && entity != null) {
            if (!this.isAcceptibleReturnOwner()) {
                if (!this.level().isClientSide() && this.pickup == AbstractArrow.Pickup.ALLOWED) {
                    com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, this.getDefaultPickupItem(), 0.1F);
                }
    ...
    protected void onHitEntity(EntityHitResult hitResult) {
        ...
        if (entity.hurtOrSimulate(damagesource, f)) {
            ...
            if(entity1 != null){
                DinosaurSpiritEntity dinosaurSpirit = ACEntityRegistry.DINOSAUR_SPIRIT.get().create(level(), net.minecraft.world.entity.EntitySpawnReason.EVENT);
