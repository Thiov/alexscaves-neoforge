...
public class ACDamageTypes {
    ...
    public static final ResourceKey<DamageType> ACID = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "acid"));
    public static final ResourceKey<DamageType> NUKE = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "nuke"));
    public static final ResourceKey<DamageType> RADIATION = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "radiation"));
    public static final ResourceKey<DamageType> RAYGUN = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "raygun"));
    public static final ResourceKey<DamageType> FORSAKEN_SONIC_BOOM = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "forsaken_sonic_boom"));
    public static final ResourceKey<DamageType> DESOLATE_DAGGER = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "desolate_dagger"));
    public static final ResourceKey<DamageType> DARK_ARROW = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "dark_arrow"));
    public static final ResourceKey<DamageType> SPIRIT_DINOSAUR = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "spirit_dinosaur"));
    public static final ResourceKey<DamageType> TREMORZILLA_BEAM = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "tremorzilla_beam"));
    public static final ResourceKey<DamageType> GUMBALL = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "gumball"));
    public static final ResourceKey<DamageType> INTENTIONAL_GAME_DESIGN = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "intentional_game_design"));
    ...
    private static class DamageSourceRandomMessages extends DamageSource {
        ...
        public Component getLocalizedDeathMessage(LivingEntity attacked) {
            ...
            if (entity != null) {
                return Component.translatable(translationKey + ".entity", attacked.getDisplayName(), entity.getDisplayName());
            }
            return Component.translatable(translationKey, attacked.getDisplayName());
        }
    }
}
