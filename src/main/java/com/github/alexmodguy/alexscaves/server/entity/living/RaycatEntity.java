...
public class RaycatEntity extends TamableAnimal implements IComandableMob {
    ...
    public static boolean checkRaycatSpawnRules(EntityType<? extends Animal> type, LevelAccessor levelAccessor, EntitySpawnReason mobType, BlockPos pos, RandomSource randomSource) {
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        this.setLayTime(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "LayTime"));
    }
