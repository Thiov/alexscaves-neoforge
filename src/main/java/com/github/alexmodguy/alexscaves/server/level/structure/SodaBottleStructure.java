...
public class SodaBottleStructure extends Structure {
    ...
    private static final Identifier[] SODA_NBT = new Identifier[]{
            Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "soda_bottle"),
            Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "soda_bottle_side")
    };
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        Identifier res = Util.getRandom(SODA_NBT, context.random());
