...
public class NotorEntity extends PathfinderMob {
    ...
    private static final EntityDataAccessor<Optional<UUID>> HOLOGRAM_ENTITY_UUID = SynchedEntityData.defineId(NotorEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    public static boolean checkNotorSpawnRules(EntityType<NotorEntity> notor, LevelAccessor level, EntitySpawnReason spawnType, BlockPos blockPos, RandomSource randomSource) {
    ...
    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput compound) {
        ...
        if (this.getHologramUUID() != null) {
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(compound, "HologramUUID", this.getHologramUUID());
        }
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        this.setShowingHologram(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "ShowingHologram"));
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.hasUUID(compound, "HologramUUID")) {
            this.setHologramUUID(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(compound, "HologramUUID"));
        }
        stopScanningFor = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "StopScanningTime");
    }
