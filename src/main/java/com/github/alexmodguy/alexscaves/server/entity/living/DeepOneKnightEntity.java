...
public class DeepOneKnightEntity extends DeepOneBaseEntity {
    ...
    public static final ResourceKey<LootTable> BARTER_LOOT = ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "gameplay/deep_one_knight_barter"));
    ...
    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput compound) {
        ...
        if (this.lastThrownTrident != null) {
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(compound, "LastTridentUUID", this.lastThrownTrident);
        }
    }

    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        super.readAdditionalSaveData(compound);
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.hasUUID(compound, "LastTridentUUID")) {
            this.lastThrownTrident = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(compound, "LastTridentUUID");
        }
    }
