...
public class NuclearFurnaceMenu extends AbstractContainerMenu {
    ...
    private boolean canSmelt(ItemStack stack) {
        return this.level.getServer() != null
            && this.level.getServer().getRecipeManager()
                .getRecipeFor(NuclearFurnaceBlockEntity.getRecipeType(), new SingleRecipeInput(stack), this.level)
                .isPresent();
    }
