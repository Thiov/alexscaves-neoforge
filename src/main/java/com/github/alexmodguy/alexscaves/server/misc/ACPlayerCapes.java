...
public class ACPlayerCapes {
    ...
    private static final Identifier DEVELOPER_CAPE_TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/cape/developer.png");
    private static final Identifier CONTRIBUTOR_CAPE_TEXTURE = Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "textures/entity/cape/contributor.png");
