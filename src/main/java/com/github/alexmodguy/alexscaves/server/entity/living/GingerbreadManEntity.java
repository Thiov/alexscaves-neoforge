...
public class GingerbreadManEntity extends Monster implements IAnimatedEntity, IDancesToJukebox, PossessedByLicowitch, TargetsDroppedItems {
    ...
    private static final EntityDataAccessor<Optional<UUID>> FLEEING_FROM_UUID = SynchedEntityData.defineId(GingerbreadManEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    public GingerbreadManEntity(EntityType<? extends Monster> entityType, Level level) {
        ...
        if(this.getNavigation() instanceof GroundPathNavigation groundPathNavigation){
            ...
            com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.setCanPassDoors(groundPathNavigation, true);
        }
    }
    ...
    public static boolean checkGingerbreadManSpawnRules(EntityType<? extends Monster> entityType, ServerLevelAccessor levelAccessor, EntitySpawnReason mobSpawnType, BlockPos blockPos, RandomSource randomSource) {
    ...
    public void tick() {
        ...
        if(this.isOvenSpawned()){
            if(despawnFromOvenCooldown-- < 0){
                ...
                com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, this.getItemInHand(InteractionHand.MAIN_HAND));
                this.setItemInHand(InteractionHand.MAIN_HAND, ItemStack.EMPTY);
                com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, this.getItemInHand(InteractionHand.OFF_HAND));
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        this.setCarryingItem(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "CarryingItem"));
        this.setOvenSpawned(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "OvenSpawned"));
        this.setGingerbreadTeamColor(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "GingerbreadTeamColor"));
        this.despawnFromOvenCooldown = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "OvenDespawnCooldown");
        this.setLostLimb(true, false, com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "LostLeftLeg"));
        this.setLostLimb(false, false, com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "LostRightLeg"));
        this.setLostLimb(true, true, com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "LostLeftArm"));
        this.setLostLimb(false, true, com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "LostRightArm"));
    }
    ...
    protected void dropFromLootTable(DamageSource damageSource, boolean b) {
        if(!this.isOvenSpawned()){
            super.dropFromLootTable((net.minecraft.server.level.ServerLevel) level(), damageSource, b);
        }
    }
    ...
    protected void dropExperience(@org.jetbrains.annotations.Nullable Entity attacker) {
        if(!this.isOvenSpawned()){
            super.dropExperience((net.minecraft.server.level.ServerLevel) level(), attacker);
        }
    }
    ...
    private void onLoseArm(boolean left, boolean arm) {
        ...
        ItemParticleOption itemParticleOption = com.github.alexmodguy.alexscaves.client.render.compat.ItemParticleOptionCompat.of(ParticleTypes.ITEM, new ItemStack(ACItemRegistry.GINGERBREAD_CRUMBS.get()));
        for(int i = 0; i < 5; i++){
        ...
        if(!level().isClientSide()){
            if(!isOvenSpawned() && shouldDropLoot((net.minecraft.server.level.ServerLevel) this.level()) && random.nextInt(2) == 0 && this.isAlive()){
                com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, new ItemStack(ACItemRegistry.GINGERBREAD_CRUMBS.get()));
            }
            if(arm){
    ...
    private class SitGoal extends Goal {
        ...
        public boolean canUse() {
            if (GingerbreadManEntity.this.isInWater()) {
                return false;
            } else {
                return GingerbreadManEntity.this.isMovementBlocked();
            }
