...
public class CandyCaneHookEntity extends ThrowableProjectile {
    ...
    private static final EntityDataAccessor<Optional<UUID>> HOOKED_ENTITY_UUID = SynchedEntityData.defineId(CandyCaneHookEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    public CandyCaneHookEntity(Player player, Level level, ItemStack itemstack, boolean offhand) {
        ...
        com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.moveTo(this, d0 + armOffset.x, d1, d2 + armOffset.z, f1, f);
            ...
            if (this.isReeling() && tickCount > 5) {
                ...
                if (favoredToHookTo != null) {
                    ...
                    if(this.getDamage() != 0){
                        ...
                        favoredToHookTo.hurtOrSimulate(damageSource, this.getDamage());
                    }
                }
            }
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput tag) {
        ...
        this.setReeling(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(tag, "Reeling"));
        if(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.contains(tag, "HookedEntityUUID")){
            this.setHookedEntityUUID(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(tag, "HookedEntityUUID"));
        }
        this.setOffhand(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(tag, "Offhand"));
    }
    ...
    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput tag) {
        ...
        if(this.getHookedEntityUUID() != null){
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(tag, "HookedEntityUUID", this.getHookedEntityUUID());
        }
