...
public class GuanoEntity extends ThrowableItemProjectile {
    ...
    public GuanoEntity(Level level, LivingEntity thrower) {
        super(ACEntityRegistry.GUANO.get(), thrower, level, net.minecraft.world.item.ItemStack.EMPTY);
    }

    public GuanoEntity(Level level, double x, double y, double z) {
        super(ACEntityRegistry.GUANO.get(), x, y, z, level, net.minecraft.world.item.ItemStack.EMPTY);
    }
