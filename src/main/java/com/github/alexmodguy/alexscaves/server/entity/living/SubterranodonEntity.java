...
public class SubterranodonEntity extends DinosaurEntity implements PackAnimal, FlyingAnimal, KeybindUsingMount, FlyingMount {
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        this.setFlying(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getBoolean(compound, "Flying"));
        this.timeFlying = com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "TimeFlying");
    }
    ...
    public void tick() {
        ...
        if (this.entityData.get(ATTACK_TICK) > 0) {
            ...
            if (attackProgress == 5F && target != null && this.distanceTo(target) < 3D + target.getBbWidth() && this.hasLineOfSight(target)) {
                target.hurtOrSimulate(this.damageSources().mobAttack(this), (float) this.getAttribute(Attributes.ATTACK_DAMAGE).getValue());
