...
public class AtlatitanEntity extends SauropodBaseEntity implements KeybindUsingMount {
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        ...
        this.setRideableFor(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getInt(compound, "RideableTime"));
    }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (!prev.consumesAction() && itemstack.is(ACItemRegistry.SERENE_SALAD.get()) && !this.isBaby()) {
            ...
            if (!remainingItem.isEmpty()) {
                com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.spawnAtLocation(this, remainingItem);
            }
