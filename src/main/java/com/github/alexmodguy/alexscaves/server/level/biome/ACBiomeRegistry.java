...
public class ACBiomeRegistry {
    public static final ResourceKey<Biome> MAGNETIC_CAVES = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "magnetic_caves"));
    public static final ResourceKey<Biome> PRIMORDIAL_CAVES = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "primordial_caves"));
    public static final ResourceKey<Biome> TOXIC_CAVES = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "toxic_caves"));
    public static final ResourceKey<Biome> ABYSSAL_CHASM = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "abyssal_chasm"));
    public static final ResourceKey<Biome> FORLORN_HOLLOWS = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "forlorn_hollows"));
    public static final ResourceKey<Biome> CANDY_CAVITY = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "candy_cavity"));
