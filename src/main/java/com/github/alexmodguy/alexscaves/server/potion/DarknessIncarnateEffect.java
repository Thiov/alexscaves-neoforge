...
public class DarknessIncarnateEffect extends MobEffect {
    ...
    public static boolean isInLight(LivingEntity living, int threshold) {
        ...
        float timeOfDay = com.github.alexmodguy.alexscaves.server.entity.util.LevelTimeCompat.getTimeOfDay(living.level(), 1.0F); //night starts at 0.259 and ends at 0.74
