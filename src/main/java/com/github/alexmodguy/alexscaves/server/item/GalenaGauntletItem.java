...
public class GalenaGauntletItem extends Item {
    ...
    public GalenaGauntletItem() {
        super(new Item.Properties().stacksTo(1).durability(400).repairable(com.github.alexmodguy.alexscaves.server.misc.ACTagRegistry.GALENA_GAUNTLET_REPAIR).rarity(Rarity.UNCOMMON).enchantable(1));
    }
