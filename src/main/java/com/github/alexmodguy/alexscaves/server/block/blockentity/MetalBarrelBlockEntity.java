...
public class MetalBarrelBlockEntity extends RandomizableContainerBlockEntity {
    ...
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        ...
        protected void onOpen(Level level, BlockPos blockPos, BlockState blockState) {
            MetalBarrelBlockEntity.this.playSound(blockState, ACSoundRegistry.METAL_BARREL_LID.get());
            MetalBarrelBlockEntity.this.updateBlockState(blockState, true);
        }

        
        protected void onClose(Level level, BlockPos blockPos, BlockState blockState) {
            MetalBarrelBlockEntity.this.playSound(blockState, ACSoundRegistry.METAL_BARREL_LID.get());
            MetalBarrelBlockEntity.this.updateBlockState(blockState, false);
        }
    ...
    public MetalBarrelBlockEntity(BlockPos blockPos, BlockState blockState) {
        super(ACBlockEntityRegistry.METAL_BARREL.get(), blockPos, blockState);
    }
