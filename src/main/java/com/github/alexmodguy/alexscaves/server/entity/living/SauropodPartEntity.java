...
public class SauropodPartEntity extends PartEntity<SauropodBaseEntity> {
    ...
    public boolean isInvulnerableTo(DamageSource damageSource) {
        SauropodBaseEntity parent = this.getParent();
        return super.isInvulnerableToBase(damageSource) || parent != null && com.github.alexmodguy.alexscaves.server.entity.util.EntityCompat.isInvulnerableTo(parent, damageSource) || damageSource.getEntity() != null && parent != null && parent.isPassengerOfSameVehicle(damageSource.getEntity());
    }
