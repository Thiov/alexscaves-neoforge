...
public class UndergroundCabinStructurePiece extends UndergroundTemplateStructurePiece {
    ...
    public UndergroundCabinStructurePiece(StructureTemplateManager manager, Identifier resourceLocation, BlockPos pos, Rotation rotation) {
    ...
    protected void handleDataMarker(String string, BlockPos pos, ServerLevelAccessor accessor, RandomSource random, BoundingBox box) {
        ...
        switch (string) {
            case "loot_chest":
                ResourceKey<LootTable> chestLoot = pickedBiome == null ? BuiltInLootTables.SIMPLE_DUNGEON : ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "chests/underground_cabin_" + pickedBiome.identifier().getPath()));
