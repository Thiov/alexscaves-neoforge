...
public class MineGuardianAnchorEntity extends Entity {
    ...
    private static final EntityDataAccessor<Optional<UUID>> GUARDIAN_UUID = SynchedEntityData.defineId(MineGuardianAnchorEntity.class, com.github.alexmodguy.alexscaves.server.entity.ACEntityDataRegistry.OPTIONAL_UUID.get());
    ...
    public void tick() {
        ...
        if (!level().isClientSide()) {
            ...
            if (guardian instanceof MineGuardianEntity mineGuardian) {
                ...
                double distanceGoal = (mineGuardian.isInWater() ? i + Math.sin(tickCount * 0.1F + i * 0.5F) * 0.25F : 5) + (hasTarget ? 5 : 0);
    ...
    public void readAdditionalSaveData(net.minecraft.world.level.storage.ValueInput compound) {
        if (com.github.alexmodguy.alexscaves.server.misc.NbtCompat.hasUUID(compound, "GuardianUUID")) {
            this.setGuardianUUID(com.github.alexmodguy.alexscaves.server.misc.NbtCompat.getUUID(compound, "GuardianUUID"));
        }
    }
    ...
    public void addAdditionalSaveData(net.minecraft.world.level.storage.ValueOutput compound) {
        if (this.getGuardianUUID() != null) {
            com.github.alexmodguy.alexscaves.server.misc.NbtCompat.putUUID(compound, "GuardianUUID", this.getGuardianUUID());
        }
    }
