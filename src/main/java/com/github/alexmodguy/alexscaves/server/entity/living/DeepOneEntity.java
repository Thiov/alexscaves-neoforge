...
public class DeepOneEntity extends DeepOneBaseEntity {
    ...
    public static final ResourceKey<LootTable> BARTER_LOOT = ResourceKey.create(Registries.LOOT_TABLE, Identifier.fromNamespaceAndPath(AlexsCaves.MODID, "gameplay/deep_one_barter"));
